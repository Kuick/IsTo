...
{
	public class ToOfGenericToUInt32
	{
		[Fact]
		public void BySelf()
		{
			var value = (UInt32)123;
			Assert.True(value.To<UInt32>() == value);
		}
		...
		[InlineData("8.12345678", 0)]
		[InlineData("8.12345678901234", 0)]
		public void ByPrimative<T>(T value, UInt32 expect)
		{
			Assert.True(value.To<UInt32>() == expect);
		}
		...
		public void FromDateTime()
		{
			...
			UInt32 flag;
			Assert.False(value.TryTo<UInt32>(out flag));
		}
	}
}
