...
{
	public class ToOfGenericToUInt16
	{
		[Fact]
		public void BySelf()
		{
			var value = (UInt16)123;
			Assert.True(value.To<UInt16>() == value);
		}
		...
		[InlineData("8.12345678", 0)]
		[InlineData("8.12345678901234", 0)]
		public void ByPrimative<T>(T value, UInt16 expect)
		{
			Assert.True(value.To<UInt16>() == expect);
		}
		...
		public void FromDateTime()
		{
			...
			UInt16 flag;
			Assert.False(value.TryTo<UInt16>(out flag));
		}
	}
}
