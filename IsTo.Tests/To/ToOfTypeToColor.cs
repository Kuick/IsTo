...
{
	public class ToOfTypeToColor
	{
		[Fact]
		public void BySelf()
		{
			var value = Color.Azure;
			Assert.True((Color)value.To(typeof(Color)) == value);
		}
		...
		public void ByRGBStringToColor(
			...
			int b)
		{
			var result = (Color)value.To(typeof(Color));
		...
		public void ByIntegerToColor()
		{
			...
			var color2 = (Color)color1.ToArgb().To(typeof(Color));

			Assert.True(ColorComaparison(
				(Color)0.To(typeof(Color)),
				Color.FromArgb(0)
			));
			Assert.True(ColorComaparison(
				(Color)100.To(typeof(Color)),
				Color.FromArgb(100)
			));
			Assert.True(ColorComaparison(
				color1,
		...
		public void ByColorToColor()
		{
			...
			Assert.True(ColorComaparison((Color)c.To(typeof(Color)), c));
		}
	}
}
