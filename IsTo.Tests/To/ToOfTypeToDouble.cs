...
{
	public class ToOfTypeToDouble
	{
		[Fact]
		public void BySelf()
		{
			var value = (Double)123.456;
			Assert.True((Double)value.To(typeof(Double)) == value);
		}
		...
		[InlineData("8.12345678", 8.12345678)]
		[InlineData("8.12345678901234", 8.12345678901234)]
		public void ByPrimative<T>(T value, Double expect)
		{
			Assert.True((Double)value.To(typeof(Double)) == expect);
		}
