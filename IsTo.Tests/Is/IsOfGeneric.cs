...
namespace IsTo.Tests
{
	public class IsOfGeneric
	{
		...
		{
			var result = value.Is<IComparable>();
		...
		public void ByTest22ForIComparable()
		{
			...
			var result = value.Is<IComparable<int>>();
			var expect = true;
			Assert.True(result == expect);
		}
		...
		private void ByPrimaryMain<T>(T value)
		{
			...
			Assert.False(value.Is<DateTime>());
			Assert.False(value.Is<Decimal>());
			Assert.False(value.Is<Test11>());
		}
		...
		{
			Assert.False(value.Is<Array>());
			Assert.True(value.Is<Enum>()); // True
			Assert.False(value.Is<Stream>());
			Assert.False(value.Is<Color>());
			Assert.False(value.Is<String>());
			Assert.False(value.Is<DateTime>());
			Assert.False(value.Is<Decimal>());
			Assert.False(value.Is<Boolean>());
			Assert.False(value.Is<Char>());
			Assert.False(value.Is<Byte>());
			Assert.False(value.Is<SByte>());
			Assert.False(value.Is<Int16>());
			Assert.False(value.Is<UInt16>());
			Assert.False(value.Is<Int32>());
			Assert.False(value.Is<UInt32>());
			Assert.False(value.Is<IntPtr>());
			Assert.False(value.Is<UIntPtr>());
			Assert.False(value.Is<Int64>());
			Assert.False(value.Is<UInt64>());
			Assert.False(value.Is<Single>());
			Assert.False(value.Is<Double>());

			Assert.True(value.Is<Animal>()); // True
			Assert.False(value.Is<ITest11>());
			Assert.False(value.Is<ITest12>());
			Assert.False(value.Is<Test11>());
			Assert.False(value.Is<Test12>());
			Assert.False(value.Is<Test13>());
			Assert.False(value.Is<ITest21<string>>());
			Assert.False(value.Is<ITest21<DateTime>>());
			Assert.False(value.Is<ITest22<string>>());
			Assert.False(value.Is<ITest22<DateTime>>());
			Assert.False(value.Is<Test21<string>>());
			Assert.False(value.Is<Test21<DateTime>>());
			Assert.False(value.Is<Test22<string, int>>());
			Assert.False(value.Is<Test22<string, DateTime>>());
			Assert.False(value.Is<Test23<string, int>>());
			Assert.False(value.Is<Test23<string, DateTime>>());
		}
		...
		{
			Assert.False(value.Is<Array>());
			Assert.False(value.Is<Enum>());
			Assert.True(value.Is<Stream>()); // True
			Assert.False(value.Is<Color>());
			Assert.False(value.Is<String>());
			Assert.False(value.Is<DateTime>());
			Assert.False(value.Is<Decimal>());
		...
		public void ByColor<T>(T value)
		{
			...
			Assert.False(value.Is<Enum>());
			Assert.False(value.Is<Stream>());
			Assert.True(value.Is<Color>()); // True
			Assert.False(value.Is<String>());
			Assert.False(value.Is<DateTime>());
			Assert.False(value.Is<Decimal>());
			Assert.False(value.Is<Boolean>());
		...
		public void ByString<T>(T value)
		{
			...
			Assert.False(value.Is<Stream>());
			Assert.False(value.Is<Color>());
			Assert.True(value.Is<String>()); // True
			Assert.False(value.Is<DateTime>());
			Assert.False(value.Is<Decimal>());
			Assert.False(value.Is<Boolean>());
			Assert.False(value.Is<Char>());
		...
		public void ByDateTime<T>(T value)
		{
			...
			Assert.False(value.Is<Color>());
			Assert.False(value.Is<String>());
			Assert.True(value.Is<DateTime>()); // True
			Assert.False(value.Is<Decimal>());
			Assert.False(value.Is<Boolean>());
			Assert.False(value.Is<Char>());
			Assert.False(value.Is<Byte>());
		...
		public void ByDecimal<T>(T value)
		{
			...
			Assert.False(value.Is<String>());
			Assert.False(value.Is<DateTime>());
			Assert.True(value.Is<Decimal>()); // True
			Assert.False(value.Is<Boolean>());
			Assert.False(value.Is<Char>());
			Assert.False(value.Is<Byte>());
			Assert.False(value.Is<SByte>());
		...
		public void ByBoolean<T>(T value)
		{
			...
			Assert.False(value.Is<DateTime>());
			Assert.False(value.Is<Decimal>());
			Assert.True(value.Is<Boolean>()); // True
			Assert.False(value.Is<Char>());
			Assert.False(value.Is<Byte>());
			Assert.False(value.Is<SByte>());
			Assert.False(value.Is<Int16>());
		...
		public void ByChar<T>(T value)
		{
			...
			Assert.False(value.Is<Decimal>());
			Assert.False(value.Is<Boolean>());
			Assert.True(value.Is<Char>()); // True
			Assert.False(value.Is<Byte>());
			Assert.False(value.Is<SByte>());
			Assert.False(value.Is<Int16>());
			Assert.False(value.Is<UInt16>());
		...
		public void ByByte<T>(T value)
		{
			...
			Assert.False(value.Is<Boolean>());
			Assert.False(value.Is<Char>());
			Assert.True(value.Is<Byte>()); // True
			Assert.False(value.Is<SByte>());
			Assert.False(value.Is<Int16>());
			Assert.False(value.Is<UInt16>());
			Assert.False(value.Is<Int32>());
		...
		public void BySByte<T>(T value)
		{
			...
			Assert.False(value.Is<Char>());
			Assert.False(value.Is<Byte>());
			Assert.True(value.Is<SByte>()); // True
			Assert.False(value.Is<Int16>());
			Assert.False(value.Is<UInt16>());
			Assert.False(value.Is<Int32>());
			Assert.False(value.Is<UInt32>());
		...
		public void ByInt16<T>(T value)
		{
			...
			Assert.False(value.Is<Byte>());
			Assert.False(value.Is<SByte>());
			Assert.True(value.Is<Int16>()); // True
			Assert.False(value.Is<UInt16>());
			Assert.False(value.Is<Int32>());
			Assert.False(value.Is<UInt32>());
			Assert.False(value.Is<IntPtr>());
		...
		public void ByUInt16<T>(T value)
		{
			...
			Assert.False(value.Is<SByte>());
			Assert.False(value.Is<Int16>());
			Assert.True(value.Is<UInt16>()); // True
			Assert.False(value.Is<Int32>());
			Assert.False(value.Is<UInt32>());
			Assert.False(value.Is<IntPtr>());
			Assert.False(value.Is<UIntPtr>());
		...
		public void ByInt32<T>(T value)
		{
			...
			Assert.False(value.Is<Int16>());
			Assert.False(value.Is<UInt16>());
			Assert.True(value.Is<Int32>()); // True
			Assert.False(value.Is<UInt32>());
			Assert.False(value.Is<IntPtr>());
			Assert.False(value.Is<UIntPtr>());
			Assert.False(value.Is<Int64>());
		...
		public void ByUInt32<T>(T value)
		{
			...
			Assert.False(value.Is<UInt16>());
			Assert.False(value.Is<Int32>());
			Assert.True(value.Is<UInt32>()); // True
			Assert.False(value.Is<IntPtr>());
			Assert.False(value.Is<UIntPtr>());
			Assert.False(value.Is<Int64>());
			Assert.False(value.Is<UInt64>());
		...
		public void ByIntPtr<T>(T value)
		{
			...
			Assert.False(value.Is<Int32>());
			Assert.False(value.Is<UInt32>());
			Assert.True(value.Is<IntPtr>()); // True
			Assert.False(value.Is<UIntPtr>());
			Assert.False(value.Is<Int64>());
			Assert.False(value.Is<UInt64>());
			Assert.False(value.Is<Single>());
		...
		public void ByUIntPtr<T>(T value)
		{
			...
			Assert.False(value.Is<UInt32>());
			Assert.False(value.Is<IntPtr>());
			Assert.True(value.Is<UIntPtr>()); // True
			Assert.False(value.Is<Int64>());
			Assert.False(value.Is<UInt64>());
			Assert.False(value.Is<Single>());
			Assert.False(value.Is<Double>());
		...
		public void ByInt64<T>(T value)
		{
			...
			Assert.False(value.Is<IntPtr>());
			Assert.False(value.Is<UIntPtr>());
			Assert.True(value.Is<Int64>()); // True
			Assert.False(value.Is<UInt64>());
			Assert.False(value.Is<Single>());
			Assert.False(value.Is<Double>());
		...
		public void ByUInt64<T>(T value)
		{
			...
			Assert.False(value.Is<UIntPtr>());
			Assert.False(value.Is<Int64>());
			Assert.True(value.Is<UInt64>()); // True
			Assert.False(value.Is<Single>());
			Assert.False(value.Is<Double>());
		...
		public void BySingle<T>(T value)
		{
			...
			Assert.False(value.Is<Int64>());
			Assert.False(value.Is<UInt64>());
			Assert.True(value.Is<Single>()); // True
			Assert.False(value.Is<Double>());
		...
		public void ByDouble<T>(T value)
		{
			...
			Assert.False(value.Is<UInt64>());
			Assert.False(value.Is<Single>());
			Assert.True(value.Is<Double>()); // True
		...
		public void ByTest11<T>(T value)
		{
			...
			Assert.False(value.Is<Animal>());
			Assert.True(value.Is<ITest11>()); // True
			Assert.False(value.Is<ITest12>());
			Assert.True(value.Is<Test11>() == isClass);
			Assert.False(value.Is<Test12>());
			Assert.False(value.Is<Test13>());
			Assert.False(value.Is<ITest21<string>>());
			Assert.False(value.Is<ITest21<DateTime>>());
		...
		public void ByTest12<T>(T value)
		{
			...
			Assert.False(value.Is<Animal>());
			Assert.True(value.Is<ITest11>() == isClass);
			Assert.True(value.Is<ITest12>()); // True
			Assert.True(value.Is<Test11>() == isClass);
			Assert.True(value.Is<Test12>() == isClass);
			Assert.False(value.Is<Test13>());
			Assert.False(value.Is<ITest21<string>>());
			Assert.False(value.Is<ITest21<DateTime>>());
			Assert.False(value.Is<ITest22<string>>());
		...
		public void ByTest13<T>(T value)
		{
			...
			Assert.True(value.Is<ITest11>()); // True
			Assert.True(value.Is<ITest12>()); // True
			Assert.True(value.Is<Test11>()); // True
			Assert.True(value.Is<Test12>()); // True
			Assert.True(value.Is<Test13>()); // True
			Assert.False(value.Is<ITest21<string>>());
			Assert.False(value.Is<ITest21<DateTime>>());
			Assert.False(value.Is<ITest22<string>>());
			Assert.False(value.Is<ITest22<DateTime>>());
		...
		public void ByTest21<T>(T value)
		{
			...
			Assert.False(value.Is<Test12>());
			Assert.False(value.Is<Test13>());
			Assert.True(value.Is<ITest21<string>>()); // True
			Assert.False(value.Is<ITest21<DateTime>>());
			Assert.False(value.Is<ITest22<string>>());
			Assert.False(value.Is<ITest22<DateTime>>());
			Assert.True(value.Is<Test21<string>>() == isClass);
			Assert.False(value.Is<Test21<DateTime>>());
			Assert.False(value.Is<Test22<string, int>>());
			Assert.False(value.Is<Test22<string, DateTime>>());
			Assert.False(value.Is<Test23<string, int>>());
		...
		public void ByTest22<T>(T value)
		{
			...
			Assert.False(value.Is<Test12>());
			Assert.False(value.Is<Test13>());
			Assert.True(value.Is<ITest21<string>>() == isClass);
			Assert.False(value.Is<ITest21<DateTime>>());
			Assert.False(value.Is<ITest22<string>>());
			Assert.True(value.Is<ITest22<DateTime>>()); // True
			Assert.True(value.Is<Test21<string>>() == isClass);
			Assert.False(value.Is<Test21<DateTime>>());
			Assert.False(value.Is<Test22<string, int>>());
			Assert.True(value.Is<Test22<string, DateTime>>() == isClass);
			Assert.False(value.Is<Test23<string, int>>());
			Assert.False(value.Is<Test23<string, DateTime>>());
		}
		...
		public void ByTest23<T>(T value)
		{
			...
			Assert.False(value.Is<ITest22<string>>());
			Assert.True(value.Is<ITest22<DateTime>>()); // True
			Assert.True(value.Is<Test21<string>>()); // True
			Assert.False(value.Is<Test21<DateTime>>());
			Assert.False(value.Is<Test22<string, int>>());
			Assert.True(value.Is<Test22<string, DateTime>>()); // True
			Assert.False(value.Is<Test23<string, int>>());
			Assert.True(value.Is<Test23<string, DateTime>>() == isClass);
		}
	}
}